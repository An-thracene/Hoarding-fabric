package com.siming.hoarding.client.block;

import com.siming.hoarding.Hoarding;
import com.siming.hoarding.client.item.ModItemGroup;
...
public class ModBlocks {
    ...
    public static final Block BAKED_POTATO_CRATE =registerBlock("baked_potato_crate",
            new Block(FabricBlockSettings.of(Material.STONE)
                    .strength(1.0f,10.0f)),ModItemGroup.HOARDING);
    ...
    private static Item registerBlockItem(String name, Block block, ItemGroup itemGroup){
        return Registry.register(Registry.ITEM, new Identifier(Hoarding.MOD_ID, name),
